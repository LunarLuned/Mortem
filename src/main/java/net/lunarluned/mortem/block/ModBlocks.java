...
import net.lunarluned.mortem.block.custom.*;
...
public class ModBlocks {
    ...
    public static final Block APPLE_PIE = registerBlockWithItemThatStacksToOne("apple_pie",
            new ApplePieBlock(BlockBehaviour.Properties.of().forceSolidOn().strength(0.5F).sound(SoundType.WOOL).pushReaction(PushReaction.DESTROY).setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, "apple_pie")))));

    public static final Block COPPER_RAIL = registerBlock("copper_rail",
            new CopperRailBlock(BlockBehaviour.Properties.of().strength(.7f).setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, "copper_rail"))).sound(SoundType.METAL).noCollision()));
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, name), block);
    }
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, name),
                new BlockItem(block, new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, name))).useBlockDescriptionPrefix()));
    }

    private static void registerBlockItemStacksTo1(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, name),
                new BlockItem(block, new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Mortem.MOD_ID, name))).useBlockDescriptionPrefix()));
    }
